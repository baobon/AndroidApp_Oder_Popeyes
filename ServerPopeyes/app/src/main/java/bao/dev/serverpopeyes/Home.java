...
//                        .setAction("Action", null).show();
    ...
    private void showDialog() {
        ...
        alertDialog.setTitle("Thêm mới Category");
        alertDialog.setMessage("Tên & Hình Ảnh Category");
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (edtName.getText().toString().isEmpty() == true) {
                    Toast.makeText(Home.this, "Vui lòng nhập tên Category", Toast.LENGTH_SHORT).show();
                } else {
                    if (newCategory != null) {
    ...
    private void chooseImage() {
        ...
        startActivityForResult(Intent.createChooser(intent
                , "Select Picture"), Common.PICK_IMAGE_REQUEST);
    }
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //Code late -> send Category ID and Start new Activity
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (edtName.getText().toString().isEmpty() == true) {
                    ...
                    if (newCategory != null) {
                        categories.push().setValue(newCategory);
                        Snackbar.make(drawer, newCategory.getName() + " đã được thêm vào Menu"
                                , Snackbar.LENGTH_SHORT)
                                .show();
                    }
                }
