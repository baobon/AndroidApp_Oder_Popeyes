...
//                                Toast.makeText(Home.this, ""+clickItem.getName(), Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_cart) {
            ...
            //go link : https://popeyes.vn/story
            String history ="story";
            gotoPopeyesHistory(history);
    ...
    private void gotoPopeyesHistory(String history) {
        try {
            Intent historyIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://popeyes.vn/" +history));
